...
FFDIR = os.path.expanduser('~/Go/cgff')
FFMETADATAFILE = os.path.expanduser('~/Go/cgff/ffs/ff_metadata.txt')
NATIVEDIR = os.path.expanduser('~/Go/native_struct/mapped')
NATIVEMETADATAFILE = os.path.expanduser('~/Go/native_struct/native_metadata.txt')
...
def parseAA(PolyPrefix, MasterDir = None, TempSet = None):
    ...
    if MasterDir is None: MasterDir = os.path.expanduser('~/Go/%s_AA' % PolyPrefix)
